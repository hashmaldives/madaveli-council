...
class CouncilResourceLayout extends Layout
{
    /**
     ...
     * @var string
     */
    protected $name = 'councilresourcelayout';
     ...
     * @var string
     */
    protected $title = 'Council Resources';
    ...
    {
        return [
            Select::make('Select a Category','category')->nullable()->options(\App\Models\PublicationCategory::pluck('title_en', 'slug'))->displayUsingLabels(),
