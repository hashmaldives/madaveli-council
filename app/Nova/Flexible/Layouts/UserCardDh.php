...
class UserCardDh extends Layout
{
    /**
     ...
     * @var string
     */
    protected $title = 'User Card Block';
    ...
    public function fields()
    {
        return [
            ...
            ThaanaText::make('Full Name', 'name')->rules('required'),
            ThaanaText::make('Position', 'position')->rules('required'),
