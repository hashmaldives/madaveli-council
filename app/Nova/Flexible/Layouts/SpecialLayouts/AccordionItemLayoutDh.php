...
class AccordionItemLayoutDh extends Layout
{
    /**
     ...
     * @var string
     */
    protected $name = 'accordionitemlayout';
     ...
     * @var string
     */
    protected $title = 'Accordion Item';
    ...
    public function fields()
    {
        return [
            ...
            Flexible::make('Content', 'content')->rules('required')->stacked()->button('Add Block')
                ->menu(
