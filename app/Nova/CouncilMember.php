...
class CouncilMember extends Resource
{
    /**
     ...
     * @var string
     */
    public static $model = \App\Models\CouncilMember::class;
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            BelongsTo::make('Gender','gender','App\Nova\Gender')->rules('required'),
            BelongsTo::make('Political Party','political_party','App\Nova\PoliticalParty')->rules('required'),
            Boolean::make('Enable Short Description', 'shortdesc')->hideFromIndex()->default(false)->help('Check this option to display short description on the website.'),
            ...
            BelongsToMany::make('Council Term', 'council_terms')
