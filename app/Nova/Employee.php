...
class Employee extends Resource
{
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            MediaHubField::make('Image', 'image')->defaultCollection('staffs')->rules('required'),
            ...
            BelongsToMany::make('Employee Section', 'employee_sections')
            ->fields(function ($request) {
                return [
                    Select::make('Level', 'level')->options([
                        ...
                        'Select the level of this employee.'
                    )->rules('required'),
