<div>
    ...
    <form class="hash-form" id="contact_form" wire:submit.prevent="submit">
        ...
        @if(!empty( nova_get_setting('contact_form_dec_en') && nova_get_setting('contact_form_dec_dh') ))
            ...
            <div class="form-row">
                @php
                $contact_form_dec_en = nova_get_setting('contact_form_dec_en');
                $contact_form_dec_dh = nova_get_setting('contact_form_dec_dh');
                @endphp
                <x-elements.general.rich-text
                    ...
                    dualLanguage="true" 
                    :language=$language
                    :contentEn=$contact_form_dec_en
                    :contentDh=$contact_form_dec_dh
                />
            </div>
        @endif
