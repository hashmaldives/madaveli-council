          ...
          @if($page->enable_sidebar == 1)
              ...
              <div class="col-lg-4">
                <div class="sidebar pt-3">
                  <div class="lang-{{$language}} visible">
                    @if($language == 'dh')
                      <livewire:handlers.sidebar-handler-component :data="$page->sidebar->content_dh"/>
                    @elseif($language == 'en')
                      <livewire:handlers.sidebar-handler-component :data="$page->sidebar->content_en"/>
                    @endif
                  </div>
                </div>
              </div><!--col-lg-4-->
